      ...
      <div class="row properties-box">
        <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 adv">
          <div class="item">
            ...
            <h6>18.1</h6>
            <span <?php if ($_SESSION['media']>=18.1) {echo "class="gr"";} ifelse ($_SESSION['media']<18.1) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Engenharia Informática</a></h4></span>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 str">
          <div class="item">
            ...
            <span class="category">IS. Técnico</span>
            <h6>18.8</h6>
            <span <?php if ($_SESSION['media']>=18.8) {echo "class="gr"";} ifelse ($_SESSION['media']<18.8) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Engenharia Física e Tecnologica</a></h4></span>
            <div class="main-button">
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 rac">
          <div class="item">
            ...
            <h6>17.7</h6>
            <span <?php if ($_SESSION['media']>=17.7) {echo "class="gr"";} ifelse ($_SESSION['media']<17.7) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Arquitetura</a></h4></span>
            <div class="main-button">
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 con">
          <div class="item">
            ...
            <h6>18.7</h6>
            <span <?php if ($_SESSION['media']>=18.7) {echo "class="gr"";} ifelse ($_SESSION['media']<18.7) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Engenharia e Gestão Industrial</a></h4></span>
            <div class="main-button">
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 ent">
          <div class="item">
            ...
            <span class="category">U. Porto</span>
            <h6>18.1</h6>
            <span <?php if ($_SESSION['media']>=18.1) {echo "class="gr"";} ifelse ($_SESSION['media']<18.1) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Gestão</a></h4></span>
            <div class="main-button">
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 soc">
          <div class="item">
            ...
            <span class="category">U. Porto</span>
            <h6>17.9</h6>
            <span <?php if ($_SESSION['media']>=17.9) {echo "class="gr"";} ifelse ($_SESSION['media']<17.9) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Psicologia</a></h4></span>
            <div class="main-button">
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 rac">
          <div class="item">
            ...
            <h6>17.6</h6>
            <span <?php if ($_SESSION['media']>=17.6) {echo "class="gr"";} ifelse ($_SESSION['media']<17.6) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Desenho</a></h4></span>
            <div class="main-button">
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 adv">
          <div class="item">
            ...
            <span class="category">U. Porto</span>
            <h6>17.8</h6>
            <span <?php if ($_SESSION['media']>=17.8) {echo "class="gr"";} ifelse ($_SESSION['media']<17.8) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Engenharia Mecânica</a></h4></span>
            <div class="main-button">
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 adv">
          <div class="item">
            ...
            <span class="category">U. Porto</span>
            <h6>15.0</h6>
            <span <?php if ($_SESSION['media']>=15) {echo "class="gr"";} ifelse ($_SESSION['media']<15) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Engenharia de Materias</a></h4></span>
            <div class="main-button">
       ...
       <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 con">
          <div class="item">
            ...
            <span class="category">U. Minho</span>
            <h6>13.4</h6>
            <span <?php if ($_SESSION['media']>=13.4) {echo "class="gr"";} ifelse ($_SESSION['media']<13.4) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Engenharia de Polímeros</a></h4></span>
            <div class="main-button">
          ...
          <div class="item">
            ...
            <h6>16.7</h6>
            <span <?php if ($_SESSION['media']>=16.7) {echo "class="gr"";} ifelse ($_SESSION['media']<16.7) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Gestão de Marketing</a></h4></span>
            <div class="main-button">
          ...
          <div class="item">
            ...
            <span class="category">U. Lisboa</span>
            <h6>16.0</h6>
            <span <?php if ($_SESSION['media']>=16) {echo "class="gr"";} ifelse ($_SESSION['media']<16) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Design de Equipamento</a></h4></span>
            <div class="main-button">
          ...
          <div class="item">
            ...
            <span class="category">IS. Técnico</span>
            <h6>14.9</h6>
            <span <?php if ($_SESSION['media']>=14.9) {echo "class="gr"";} ifelse ($_SESSION['media']<14.9) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Engenharia do Ambiente</a></h4></span>
            <div class="main-button">
          ...
          <div class="item">
            ...
            <span class="category">U. Lisboa</span>
            <h6>13.8</h6>
            <span <?php if ($_SESSION['media']>=13.8) {echo "class="gr"";} ifelse ($_SESSION['media']<13.8) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Educação e Formação</a></h4></span>
            <div class="main-button">
          ...
          <div class="item">
            ...
            <span class="category">U. Minho</span>
            <h6>16.0</h6>
            <span <?php if ($_SESSION['media']>=16) {echo "class="gr"";} ifelse ($_SESSION['media']<16) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Administração Pública</a></h4></span>
            <div class="main-button">
          ...
          <div class="item">
            ...
            <h6>17.6</h6>
            <span <?php if ($_SESSION['media']>=17.6) {echo "class="gr"";} ifelse ($_SESSION['media']<17.6) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Direita</a></h4></span>
            <div class="main-button">
          ...
          <div class="item">
            ...
            <span class="category">U. Lisboa</span>
            <h6>16.7</h6>
            <span <?php if ($_SESSION['media']>=16.7) {echo "class="gr"";} ifesle ($_SESSION['media']<16.7) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Biologia</a></h4></span>
            <div class="main-button">
          ...
          <div class="item">
            ...
            <span class="category">U. Lisboa</span>
            <h6>17.0</h6>
            <span <?php if ($_SESSION['media']>=17) {echo "class="gr"";} ifelse ($_SESSION['media']<17) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Física</a></h4></span>
            <div class="main-button">
            ...
            <span class="category">U. Minho</span>
            <h6>12.8</h6>
            <span <?php if ($_SESSION['media']>=12.8) {echo "class="gr"";} ifelse ($_SESSION['media']<12.8) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Química</a></h4></span>
            <div class="main-button">
            ...
            <span class="category">U. Lisboa</span>
            <h6>14.4</h6>
            <span <?php if ($_SESSION['media']>=14.4) {echo "class="gr"";} ifelse ($_SESSION['media']<14.4) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Geologia</a></h4></span>
            <div class="main-button">
            ...
            <span class="category">U. Minho</span>
            <h6> 18.6</h6>
            <span <?php if ($_SESSION['media']>=18.6) {echo "class="gr"";} ifelse ($_SESSION['media']<18.6) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Medicina</a></h4></span>
            <div class="main-button">
            ...
            <span class="category">U. Porto</span>
            <h6>17.1</h6>
            <span <?php if ($_SESSION['media']>=17.1) {echo "class="gr"";} ifelse ($_SESSION['media']<17.1) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Design de Comunicação</a></h4></span>
            <div class="main-button">
            ...
            <span class="category">U. Lisboa</span>
            <h6>17.1</h6>
            <span <?php if ($_SESSION['media']>=17.1) {echo "class="gr"";} ifelse ($_SESSION['media']<17.1) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Arte Multimédia</a></h4></span>
            <div class="main-button">
            ...
            <span class="category">U. Minho</span>
            <h6>11.7</h6>
            <span <?php if ($_SESSION['media']>=11.7) {echo "class="gr"";} ifelse ($_SESSION['media']<11.7) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Engenharia Têxtil</a></h4></span>
            <div class="main-button">
         ...
         <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 ent">
            ...
            <span class="category">U. Minho</span>
            <h6>16.8</h6>
            <span <?php if ($_SESSION['media']>=16.8) {echo "class="gr"";} ifelse ($_SESSION['media']<16.8) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Contablilidade</a></h4></span>
            <div class="main-button">
            ...
            <span class="category">IS. Técnico</span>
            <h6>16.6</h6>
            <span <?php if ($_SESSION['media']>=16.6) {echo "class="gr"";} ifelse ($_SESSION['media']<16.6) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Engenharia Naval e Oceânica</a></h4></span>
            <div class="main-button">
            ...
            <h6>15.2</h6>
            <span <?php if ($_SESSION['media']>=15.2) {echo "class="gr"";} ifelse ($_SESSION['media']<15.2) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Engenharia Civil</a></h4></span>
            <div class="main-button">
            ...
            <span class="category">U. Lisboa</span>
            <h6>15.4</h6>
            <span <?php if ($_SESSION['media']>=15.4) {echo "class="gr"";} ifelse ($_SESSION['media']<15.4) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Ciências da Arte e Património</a></h4></span>
            <div class="main-button">
            ...
            <span class="category">U. Porto</span>
            <h6>17.4</h6>
            <span <?php if ($_SESSION['media']>=17.4) {echo "class="gr"";} ifelse ($_SESSION['media']<17.4) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Economia</a></h4></span>
            <div class="main-button">
            ...
            <span class="category">U. Lisboa</span>
            <h6>16.0</h6>
            <span <?php if ($_SESSION['media']>=16) {echo "class="gr"";} ifelse ($_SESSION['media']<16) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Matemática</a></h4></span>
            <div class="main-button">
            ...
            <span class="category">IS. Técnico</span>
            <h6> 17.8</h6>
            <span <?php if ($_SESSION['media']>=17.8) {echo "class="gr"";} ifelse ($_SESSION['media']<17.8) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Engenharia Biomédica</a></h4></span>
            <div class="main-button">
            ...
            <span class="category">U. Minho</span>
            <h6> 14.2</h6>
            <span <?php if ($_SESSION['media']>=14.2) {echo "class="gr"";} ifelse ($_SESSION['media']<14.2) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Engenharia e Gestão de Sistemas de Informação</a></h4></span>
            <div class="main-button">
            ...
            <span class="category">U. NOVA Lisboa</span>
            <h6>15.1</h6>
            <span <?php if ($_SESSION['media']>=15.1) {echo "class="gr"";} ifelse ($_SESSION['media']<15.1) {echo "class="re"";} else {echo "class=""";} ?>><h4><a href="property-details.html">Sociologia</a></h4></span>
            <div class="main-button">
