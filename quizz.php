...
<div class="sadfsdag" id="popup">
    ...
    <p>Os teus traços são <?php echo isset($_SESSION['rd']) ? $_SESSION['rd'] : ''; ?>, se quiseres ver os cursos que te recomendamos, <a href="cursos.php#<?php echo isset($_SESSION['id']) ? $_SESSION['id'] : ''; ?>">Clica aqui.</a></p>
