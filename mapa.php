...
<body>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <span class="breadcrumb"><a href="#">Contacte</a>  /  Outros</span>
          <h3>Deixe o Contacto</h3>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <p>Estás a estudar fora do país e não conheces ninguém? Não te preocupes explora o nosso mapa, vê a região onde estudas e procura algum português que também estude perto de ti. Se quiseres ser contactado por outras pessoas deixa o teu contacto e a tua localização para aparecer uma marca com as tuas informações. </p>
            ...
            <div class="col-lg-4">
                <div class="counter">
                  <h2 class="timer count-title count-number" data-to="152" data-speed="1000"></h2>
                   <p class="count-text ">Estudantes<br>Localizados</p>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="counter">
                  <h2 class="timer count-title count-number" data-to="17" data-speed="1000"></h2>
                  <p class="count-text ">Países<br>Diferentes</p>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="counter">
                  <h2 class="timer count-title count-number" data-to="62" data-speed="1000"></h2>
                  <p class="count-text ">Universidades<br>Diferentes</p>
                </div>
              </div>
          </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <fieldset>
                  ...
                  <input type="text" name="email" id="email" pattern="[^ @]*@[^ @]*" placeholder="O Teu Email..." required="">
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
                  <label for="subject">Número de Telemóvel</label>
                  <input type="tel" name="subject" id="subject" placeholder="O Teu Número de Telemóvel..." autocomplete="on" >
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
                  <label for="message">A Tua localização</label>
